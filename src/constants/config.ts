export const ACADEMY_CONFIG = {
  ACADEMY_NAME: "Learn English & Earn Knowledge",
  SUB_NAME: "& Earn Knowledge",
  TAGLINE: "Better English, Better You, Brighter Future!",
  TRAINER_NAME: "Alisha Ahmed",
  TRAINER_ROLE: "English Language Trainer",
